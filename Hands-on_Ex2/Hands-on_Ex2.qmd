...
Nov 24, 2022 [Original Website](https://r4gdsa.netlify.app/chap04.html)
...
```{r}
quadrant[DV >0 & C_mI>0] <- 4 # High-High Cluster     
quadrant[DV <0 & C_mI<0] <- 2 # Low-Low Cluster     
